...
public class Bridge {
    ...
    private final Set<String> allowedOriginRules = new HashSet<String>();
    ...
    private final Map<String, LinkedList<String>> savedPermissionCallIds = new HashMap<>();
    ...
    public boolean isMinimumWebViewInstalled() {
        ...
        return amazonFireMajorWebViewVersion >= config.getMinWebViewVersion();
    ...
    public static class Builder {
        ...
        private final List<Plugin> pluginInstances = new ArrayList<>();
